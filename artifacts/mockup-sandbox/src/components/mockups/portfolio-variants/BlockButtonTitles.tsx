...
function SectionButton({ label, sub }: { label: string; sub?: string }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
      ...
      {sub && (
        <span style={{ fontFamily: "inherit", fontSize: 10, color: MUTED, letterSpacing: "0.08em" }}>{sub}</span>
      )}
    </div>
  );
}
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{ fontFamily: "inherit", fontSize: 10, color: "#0d0d0d", backgroundColor: BLUE, padding: "2px 8px", fontWeight: 700 }}>CURRENT</span>
...
function SystemBlock({ s, wide }: { s: typeof systems[0]; wide?: boolean }) {
    ...
    <>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <span style={{
          ...
          color: isFounder ? "#0d0d0d" : MUTED,
          backgroundColor: isFounder ? BLUE : "transparent",
          padding: isFounder ? "1px 6px" : undefined,
          fontWeight: isFounder ? 700 : undefined,
        }}>
          {s.tag}
        </span>
      </div>
...
export function BlockButtonTitles() {
    ...
    <div style={{ minHeight: "100vh", backgroundColor: BG, color: TEXT, fontFamily: "'JetBrains Mono', monospace", padding: "40px 48px" }}>
      <div style={{ maxWidth: 860, margin: "0 auto", display: "flex", flexDirection: "column", gap: 40 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <div style={{ fontFamily: "inherit", fontSize: 11, color: MUTED, marginTop: 4, letterSpacing: "0.04em" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <SectionButton label="WORK EXPERIENCE" sub="5 companies · 2019 — present" />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, paddingBottom: 40 }}>
          <SectionButton label="SYSTEMS DESIGNED" sub="4 operational systems built" />
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 4 }}>
            <SystemBlock s={systems[0]} wide />
            <SystemBlock s={systems[1]} />
            <SystemBlock s={systems[2]} />
            <SystemBlock s={systems[3]} wide />
          </div>
        </div>
